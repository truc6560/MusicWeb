...
<script>
    ...
    // ==========================================
    const audioPlayer = document.getElementById('my-audio-player'); // Sửa ID cho khớp với thẻ <audio> của bạn
    ...
    if(audioPlayer) {
        ...
        audioPlayer.addEventListener('timeupdate', function() {
            ...
            if (audioPlayer.currentTime > 30 && !hasRecordedHistory && currentSongId) {
