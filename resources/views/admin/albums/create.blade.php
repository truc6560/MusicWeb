...
<div class="card" style="max-width: 900px; margin: 0 auto;">
    <div class="card-header" style="border-bottom: none; margin-bottom: 0;">
        <h2 style="color: #00d1ff; text-align: center; width: 100%;"><i class="fas fa-compact-disc"></i> Thêm Album Mới</h2>
    </div>
    ...
    <form action="{{ route('admin.albums.store') }}" method="POST">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 18px;">
            ...
            <div>
                ...
                <input type="number" min="1900" max="2100" name="release_year" value="{{ old('release_year') }}" placeholder="Ví dụ: 2025" style="width: 100%; padding: 12px; background: #12141d; border: 1px solid #2d2f3b; color: #fff; border-radius: 8px; outline: none;">
            </div>
            ...
            <div style="grid-column: span 2;">
                ...
                <textarea name="description" style="width: 100%; min-height: 140px; padding: 12px; background: #12141d; border: 1px solid #2d2f3b; color: #fff; border-radius: 8px; outline: none; resize: vertical;">{{ old('description') }}</textarea>
            </div>
        </div>
