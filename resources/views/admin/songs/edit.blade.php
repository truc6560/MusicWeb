    ...
    <form action="{{ route('admin.songs.update', $song->song_id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 18px;">
            ...
            <div style="position: relative;">
                ...
                @php
                    $selectedArtist = $artists->firstWhere('artist_id', (int) old('artist_id', $song->artist_id));
                @endphp
                ...
                <input type="hidden" name="artist_id" id="artist_id" value="{{ old('artist_id', $song->artist_id) }}" required>
            ...
            <div style="position: relative;">
                ...
                @php
                    $selectedAlbum = $albums->firstWhere('album_id', (int) old('album_id', $song->album_id));
                @endphp
                ...
                <input type="hidden" name="album_id" id="album_id" value="{{ old('album_id', $song->album_id) }}">
